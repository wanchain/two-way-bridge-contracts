...
describe('decode', () => {
    ...
    //https://testnet.tonviewer.com/transaction/3da72ac351f7d44f18d6ef45c34aa2c68aea128c48da28f9ef8460ca96854fae
    it('decode userlock  coin', async () => {
        let bodyCelStr = "";
        let bodyCell = Cell.fromBoc(Buffer.from(bodyCelStr, 'hex'))[0];
        let opCode = 0x40000001;
        let decode = codeTable[opCode]["deCode"](bodyCell);
        console.log(decode);
    })
    // https://testnet.tonviewer.com/transaction/c29d2641dd97ca42420b42343117b373a97a44efaacd6cd137588930d499a3e7
    it('decode userlock  token', async () => {
        let bodyCelStr = "";
        let bodyCell = Cell.fromBoc(Buffer.from(bodyCelStr, 'hex'))[0];
        let opCode = 0x40000001;
        let decode = codeTable[opCode]["deCode"](bodyCell);
        console.log(decode);
