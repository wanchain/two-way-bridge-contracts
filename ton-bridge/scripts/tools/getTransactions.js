...
const {monitorTransactionExternalIn,monitorTransactionbyHash} = require('./util.js')
...
async function main() {
    ...
    await monitorTransactionbyHash(client, addr,Buffer.from(targetTransaction.hash,'hex').toString('base64'), targetTransaction.lt, allTransactions)
