...
describe('JettonWallet', () => {
    ...
    it.skip('works with minimal ton amount', async () => {  // TODO
        ...
        */
        ...
        console.log("deployerJettonWallet tonBalance",tonBalance)
        console.log("deployer tonBalance",(await blockchain.getContract(deployer.address)).balance)
        console.log("someJettonWallet tonBalance",(await blockchain.getContract(someJettonWallet.address)).balance)
        console.log("forwardAmount",forwardAmount)
        console.log("minimalFee",minimalFee)
        console.log("fwd_fee",fwd_fee)
        console.log("sentAmount",sentAmount)

        console.log("someAddress",someAddress.toString())
        console.log("Jw_someAddress",someJettonWallet.address.toString())

        console.log("fromAddress",deployer.address.toString())
        console.log("Jw_fromAddress",deployerJettonWallet.address.toString())

        let tonBalance2 = (await blockchain.getContract(someJettonWallet.address)).balance;
        let sendResult = await deployerJettonWallet.sendTransfer(deployer.getSender(),
            sentAmount,
            sentAmount,
            someAddress,
            deployer.address,
