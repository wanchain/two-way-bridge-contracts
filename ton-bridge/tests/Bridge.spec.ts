...
let tokenInfo = {
    coin: {
        tokenPairId: 0x01,
        srcChainId: BIP44_WANCHAIN_CHAINID,
...
describe('Bridge', () => {
    ...
    beforeAll(async () => {
        ...
        //tokenInfo.tokenOrg.walletCodeBase64 = (await getJettonWalletCode(blockchain,deployer_jetton.address)).toBoc().toString('base64');
        tokenInfo.tokenOrg.walletCodeBase64 = jwallet_code.toBoc().toString('base64');
        ...
        //tokenInfo.tokenWrapped.walletCodeBase64 = (await getJettonWalletCode(blockchain,deployer_jetton.address)).toBoc().toString('base64');
        tokenInfo.tokenWrapped.walletCodeBase64 = jwallet_code.toBoc().toString('base64');
        ...
        for (let key of Object.keys(tokenInfo)) {
            ...
            const ret = await bridge.sendAddTokenPair(deployer.getSender(), {
                ...
                walletCodeBase64: tokenInfo[key].walletCodeBase64,
            });
